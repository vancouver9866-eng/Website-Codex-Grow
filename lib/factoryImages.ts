...
export const factoryGroups: Array<{ key: FactoryImageGroup; label: string }> = [
  ...
  { key: "workshop", label: "Workshop / Partner Facility" },
...
export const trustCopy: Record<Locale, {
  ...
  en: {
    ...
    factoryTour: "View Supply Support",
  ...
  es: {
    ...
    factoryTour: "Ver soporte de abastecimiento",
  ...
  fr: {
    ...
    factoryTour: "Voir le support sourcing",
  ...
  ru: {
    ...
    factoryTour: "Поддержка поставок",
